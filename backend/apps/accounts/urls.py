...
from .backoffice_views import (
    ...
    BackofficeWorksheetLibraryCommentDestroyView,
...
urlpatterns = [
    ...
    path('demo/finalize/', FinalizeDemoAccountView.as_view()),
    ...
    path(
        'backoffice/worksheets/<uuid:worksheet_pk>/comments/<uuid:comment_pk>/',
        BackofficeWorksheetLibraryCommentDestroyView.as_view(),
    ),
