...
_board_presence_rates['student_presence'] = env.str(
    'BOARD_STUDENT_PRESENCE_THROTTLE',
    default='800/minute',
)
...
STRIPE_PRICE_BASIC_5 = env.str('STRIPE_PRICE_BASIC_5', default='').strip()
...
if STRIPE_PRICE_BASIC_5:
    STRIPE_PRICE_TO_PLAN_SLUG[STRIPE_PRICE_BASIC_5] = 'basic_5'
...
SMARTBOARD_ENABLE_BLANK_STAGE_CHECK = env.bool('SMARTBOARD_ENABLE_BLANK_STAGE_CHECK', default=True)
SMARTBOARD_BLANK_STAGE_MIN_TEXT_CHARS = env.int('SMARTBOARD_BLANK_STAGE_MIN_TEXT_CHARS', default=12)
SMARTBOARD_BLANK_STAGE_NON_WHITE_RATIO_STRICT = env.float(
    'SMARTBOARD_BLANK_STAGE_NON_WHITE_RATIO_STRICT', default=0.004,
)
SMARTBOARD_BLANK_STAGE_NON_WHITE_RATIO_RELAXED = env.float(
    'SMARTBOARD_BLANK_STAGE_NON_WHITE_RATIO_RELAXED', default=0.012,
)
