...
import { boardStageThumbnailCoverStyle, STAGE_BASE_W, STAGE_BASE_H, useBoardStageScale } from '../../boardStageLayout';
    ...
    >
      {!inView ? (
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden bg-white">
          <div className="bg-transparent" style={boardStageThumbnailCoverStyle(stageScale)}>
            <FreeHtmlBoardFrame
              html={html}
              css={css}
