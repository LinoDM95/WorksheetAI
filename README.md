...
9. **App-Server:** z. B. `gunicorn config.wsgi:application --bind 0.0.0.0:8000` — **Timeouts** des Reverse Proxy hoch genug für lange Smartboard-Pipelines (viele Minuten).
